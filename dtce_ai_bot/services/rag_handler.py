...
Please try rephrasing your question or contact support if the issue persists."""
    ...
    async def _process_rag_with_full_prompt(self, question: str, retrieved_content: str, documents: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt += "When users ask for 'past projects' or 'project examples', they want actual PROJECT DOCUMENTS from specific jobs, NOT general engineering standards or guides.\n"
            prompt += "- PROJECT DOCUMENTS: From Projects/225/, Projects/224/, etc. (actual DTCE project work)\n"
            prompt += "- ENGINEERING STANDARDS: From Engineering/ folder (general guides, standards, not specific to DTCE projects)\n"
            prompt += "- POLICIES: From Policy/ folder (company procedures)\n"
            prompt += "- PROCEDURES: From Procedures/ folder (how-to handbooks)\n\n"
