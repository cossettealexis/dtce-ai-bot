...
"""
    ...
    async def _process_rag_with_full_prompt(self, question: str, retrieved_content: str, documents: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt += "5. **Provide comprehensive responses**: ALWAYS include 'Alternative that might be helpful' and 'General Engineering Guidance' sections to give users complete context and resources\n"
            ...
            prompt += "**Alternative that might be helpful:** (ALWAYS include this section to provide comprehensive context)\n"
            ...
            prompt += "**General Engineering Guidance:** (ALWAYS include this section)\n"
            ...
            prompt += "3. ALWAYS include 'Primary Sources' section if any documents are retrieved\n"
            prompt += "4. ALWAYS include 'Alternative that might be helpful' section for comprehensive context\n"
            prompt += "5. ALWAYS include 'General Engineering Guidance' section\n"
            prompt += "6. Provide DETAILED, COMPREHENSIVE responses - don't be brief\n"
