...
"""
    ...
    async def _process_rag_with_full_prompt(self, question: str, retrieved_content: str, documents: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt += "**Alternative that might be helpful:** (MANDATORY for policy/wellness/safety queries - OPTIONAL for technical queries)\n"
            ...
            prompt += "5. **MANDATORY for policy/wellness/safety/H&S queries**: ALWAYS include 'Alternative that might be helpful' section\n"
            prompt += "6. For technical/engineering queries: Alternative section is optional\n"
