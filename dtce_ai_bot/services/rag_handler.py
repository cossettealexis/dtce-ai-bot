...
"""
    ...
    async def _process_rag_with_full_prompt(self, question: str, retrieved_content: str, documents: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt += "**Alternative that might be helpful:** (MANDATORY for policy/procedure queries - always include even if primary sources are good)\n"
            ...
            prompt += "3. ALWAYS use Markdown link format: [Document Filename](exact_url)\n"
            prompt += "4. Extract the filename from the document name and use it as the link text\n"
            prompt += "5. If you cannot find a 'Link: https://...' for a document, DO NOT include that document\n"
            prompt += "6. EXAMPLE: If you see 'DOCUMENT: Health & Safety Policy.pdf' and 'Link: https://dtcestorage.blob.core.windows.net/suitefiles/Health%20%26%20Safety%20Policy.pdf', format as: [Health & Safety Policy.pdf](https://dtcestorage.blob.core.windows.net/suitefiles/Health%20%26%20Safety%20Policy.pdf)\n\n"
