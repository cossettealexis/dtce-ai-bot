...
"""
    ...
    async def _process_rag_with_full_prompt(self, question: str, retrieved_content: str, documents: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt += "5. **Use good judgment**: Include 'Alternative that might be helpful' and 'General Engineering Guidance' sections when they genuinely add value to the user's question\n"
            ...
            prompt += "**Alternative that might be helpful:** (Include ONLY if there are genuinely helpful related documents that provide additional context)\n"
            ...
            prompt += "5. ONLY include 'Alternative that might be helpful' if there are genuinely useful related documents\n"
            prompt += "6. Don't force Alternative section - use good judgment about what adds value\n"
