...
Please try rephrasing your question or contact support if the issue persists."""
    ...
    async def _process_rag_with_full_prompt(self, question: str, retrieved_content: str, documents: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt += "- **POLICY queries**: Emphasize compliance requirements, mandatory nature. Be authoritative.\n"
            prompt += "- **PROCEDURE queries**: Frame as best practices, guidance. Mention 'this is how DTCE does it'.\n"
            prompt += "- **STANDARDS queries**: Reference official codes/standards. Mention compliance requirements.\n"
            prompt += "- **PROJECT queries**: Provide specific examples, project numbers, lessons learned.\n"
            prompt += "- **CLIENT queries**: Focus on relationship history, past collaborations, contact info.\n\n"
