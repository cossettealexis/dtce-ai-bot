...
"""
    ...
    async def _process_rag_with_full_prompt(self, question: str, retrieved_content: str, documents: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt += "  SuiteFiles Link: [COPY THE EXACT URL FROM THE 'Link: ' FIELD IN THE DOCUMENT ABOVE]\n"
            ...
            prompt += "3. ALWAYS copy the exact URL that appears after 'Link: ' in each document\n"
            prompt += "4. If you cannot find a 'Link: https://...' for a document, DO NOT include that document\n"
            prompt += "5. EXAMPLE: If you see 'Link: https://dtcestorage.blob.core.windows.net/suitefiles/Health%20%26%20Safety%20Policy.pdf', use that exact URL\n\n"
            prompt += "LINK EXAMPLES - DO THIS:\n"
            prompt += "✅ CORRECT: SuiteFiles Link: https://dtcestorage.blob.core.windows.net/suitefiles/Health%20%26%20Safety%20Policy.pdf\n"
