...
"""
    ...
    async def _process_rag_with_full_prompt(self, question: str, retrieved_content: str, documents: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt += "  SuiteFiles Link: [USE THE EXACT LINK FROM THE RETRIEVED CONTENT - look for 'Link: https://...' in the document data]\n"
            ...
            prompt += "1. NEVER write 'SuiteFiles Link: [link]' - this is FORBIDDEN\n"
            prompt += "2. ALWAYS use the exact URL that appears after 'Link: ' in each document\n"
            prompt += "3. If you cannot find a 'Link: https://...' for a document, DO NOT include that document\n"
            prompt += "4. Example: If you see 'Link: https://dtcestorage.blob.core.windows.net/...', use that exact URL\n\n"
