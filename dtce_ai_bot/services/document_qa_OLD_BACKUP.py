...
class DocumentQAService:
    ...
    def __init__(self, search_client: SearchClient):
        ...
        # Initialize RAG handler with smart prompting
...
What would you like to know?""",
            ...
            # Use unified search with folder structure awareness
            logger.info("Processing question with unified search", question=question)
            
            # Search for relevant documents with folder context
            documents = self._search_relevant_documents(question, enhanced_project_filter)
            
            if documents:
                # Generate comprehensive answer from documents
                answer_result = await self._generate_answer(question, self._prepare_context(documents))
                ...
                # Use intelligent fallback for queries without direct document matches
                logger.info("No documents found, using intelligent fallback", question=question)
                intent_response = await self._handle_intelligent_fallback(question, enhanced_project_filter)
        ...
        try:
            ...
            for result in results:
                ...
                mapped_doc = {
                    ...
                    'last_modified': doc_dict.get('last_modified', ''),
